...
RUN mkdir /sdk_build/ && mkdir /dist && apt-get update && apt-get upgrade && apt-get -y install openjdk-8-jdk git maven patch p7zip-full cabextract curl cpio zip ant && cd /sdk_build/
